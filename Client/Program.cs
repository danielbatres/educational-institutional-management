...
builder.Services.AddSingleton<GeneralSearchContext>();
builder.Services.AddSingleton<SectionContext>();
builder.Services.AddSingleton<PaymentSettingsContext>();
...
builder.Services.AddSingleton<PaymentSettingsHubManager>();
